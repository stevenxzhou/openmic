...
export const EventCard = (props: Event) => {
  ...
  const basicEventBtnStyle =
    "items-center px-4 py-2 border border-transparent rounded-xl text-sm font-medium text-white bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 hover:pointer";
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border-gray-200 p-4 sm:p-6 hover:shadow-md transition-shadow text-sm">
      <div className="flex justify-between items-center">
        ...
        <div>
          <Link
            href={`/performances/?event_id=${props.event_id}`}
            className={
              date < todayDate ? pastEventBtnStyle : activeEventBtnStyle
            }
          >
            Enter Event
          </Link>
